...
python3 tests.py                   # 59 checks, no pytest
...
Verified for the phase-2 release: 59 checks green on Python 3.9.6 and 3.14.2;
...
seed — 59 checks today, including a two-turn conversation asserted end to end
