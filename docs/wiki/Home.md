...
python3 tests.py                   # 58 checks, no pytest
...
Verified for the phase-2 release: 58 checks green on Python 3.9.6 and 3.14.2;
...
seed — 58 checks today, including a two-turn conversation asserted end to end
