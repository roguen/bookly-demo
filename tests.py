...
def an_authored_change_moves_a_verdict_through_policy_only():
    ...
    geb = ORDERS["BK-1042"]  # delivered 2026-08-22; TODAY is 2026-09-03, so 12 days
    assert policy.decide_return(
...
def multi_intent_turn_handles_both_requests():
    ...
    assert "Dune" in result.reply and "September 5" in result.reply
...
def a_genuine_refund_narration_passes_through_unreplaced():
    ...
    facts = {"title": "The Pragmatic Programmer", "order_id": "BK-0987",
              "delivered_on": "2026-06-06", "window_days": 30,
    ...
    facts = {"title": "The Pragmatic Programmer", "order_id": "BK-0987",
              "status": "delivered", "delivered_on": "2026-06-06",
...
def an_article_inside_a_title_does_not_drown_the_real_word():
    ...
    assert (
        "delivered on June 6, which is outside the 30-day return window"
        in result.reply
    ), result.reply
