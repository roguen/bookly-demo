...
- 60 checks, all dependency-free, and the decision tests never touch a model at all. They run from a terminal or from inside the console.
...
const nexts = [
  {
    ...
    f: "tests.py is the seed: 60 checks, including a two-turn conversation asserted end to end on exact strings and envelope fields. Growing it means fixtures per scenario, a rubric for narration quality, and wiring the run into CI.",
    lines: 2,
  },
  {
    n: "2",
...
That's what I'd build first. tests.py is the seed — 60 checks today, and one two-turn conversation checked line by line.
...
- 60 checks today, dependency-free, no pytest — Python 3.9 and up.
